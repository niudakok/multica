...
func LoadConfig(overrides Overrides) (Config, error) {
	...
	// QwenPaw (`qwenpaw`) runs `qwenpaw acp` over stdio using the ACP
	// (Agent Client Protocol) JSON-RPC 2.0 transport, reusing the same
	// hermesClient ACP layer as Hermes/Kimi/Kiro/Traecli.
